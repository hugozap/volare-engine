...
let input = r##"{"id":"root","type":"activity_diagram","swimlanes":[{"name":"User","activities":[{"id":"start","label":"Start","type":"start"},{"id":"login","label":"Enter Credentials","type":"normal"},{"id":"success","label":"Access Dashboard","type":"normal"}]},{"name":"System","activities":[{"id":"validate","label":"Validate User","type":"decision"},{"id":"error","label":"Show Error","type":"normal"},{"id":"retry","label":"Retry?","type":"decision"}]},{"name":"Admin","activities":[{"id":"end","label":"End","type":"end"}]}],"flows":[{"from":"start","to":"login","condition":"begin"},{"from":"login","to":"validate","condition":"submit"},{"from":"validate","to":"success","condition":"[valid credentials]"},{"from":"validate","to":"error","condition":"[invalid credentials]"},{"from":"error","to":"retry","condition":"handle error"},{"from":"retry","to":"login","condition":"[yes, retry]"},{"from":"retry","to":"end","condition":"[no, exit]"},{"from":"success","to":"end","condition":"logout"}]}"##;
