...
let input = r##"{"id":"root","type":"activity_diagram","swimlanes":[{"name":"Control","activities":[{"id":"start","label":"Start","type":"start"},{"id":"end","label":"End","type":"end"}]},{"name":"High Priority","activities":[{"id":"merge","label":"Merge","type":"merge"},{"id":"urgent","label":"Urgent Processing para este j lj l;lkj  yeah","type":"normal"}]},{"name":"Normal Priority","activities":[{"id":"classify","label":"Classify Request","type":"decision"},{"id":"normal","label":"Normal Processing","type":"normal"}]},{"name":"Low Priority","activities":[{"id":"defer","label":"Defer Processing","type":"normal"}]}],"flows":[{"from":"start","to":"classify", "condition":"prueba label"},{"from":"classify","to":"urgent","condition":"High"},{"from":"classify","to":"normal","condition":"Medium"},{"from":"classify","to":"defer","condition":"Low"},{"from":"urgent","to":"merge"},{"from":"normal","to":"merge"},{"from":"defer","to":"merge"},{"from":"merge","to":"end"}]}"##;
